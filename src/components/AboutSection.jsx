          ...
          <div className="space-y-8">
            ...
            <div className="bg-yellow-400 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] border-6 border-gray-900 p-8 transform rotate-1">
              <div className="transform -rotate-1">
                ...
                <p className="text-xl md:text-2xl font-semibold tracking-tight text-gray-900 mb4'">I'm currently open for work - let's chat!</p>
