      ...
      <div className="mx-auto text-center max-w-5xl">
        <div className="bg-white dark:bg-neutral-800 border-8 border-emerald-500 dark:border-emerald-600 p-12 transform -rotate-1">
          <div className="transform rotate-1">
            ...
            <a href={cv} target="_blank" rel="noopener noreferrer" className="items-center px-12 py-6 bg-yellow-400 dark:bg-yellow-500 text-gray-900 font-black text-2xl shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] inline-flex gap-4 border-6 border-gray-900 hover:translate-x-2 hover:translate-y-2 transition-transform">
