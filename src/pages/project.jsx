      ...
      <div className="relative isolate overflow-hidden min-h-screen">
        ...
        <main className="mx-auto max-w-5xl px-6 pt-28 pb-24">
          <header className="mb-10">
            <h1 className="text-4xl md:text-5xl font-black text-gray-900 dark:text-yellow-400 w-full mt-6">Project Title</h1>
            <p className="mt-4 text-lg font-semibold text-gray-700 dark:text-gray-300 w-full">
          ...
          <section className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
            <div>
              <h2 className="text-xl font-extrabold text-gray-900 dark:text-gray-100">Tags</h2>
              <div className="mt-4 flex flex-wrap gap-3">
                <span className="px-4 py-2 bg-yellow-400 dark:bg-yellow-500 text-gray-900 font-bold text-sm border-3 border-gray-900 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">UI/UX</span>
                <span className="px-4 py-2 bg-white dark:bg-neutral-900 text-gray-900 dark:text-gray-100 font-bold text-sm border-3 border-gray-900 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">React</span>
                <span className="px-4 py-2 bg-white dark:bg-neutral-900 text-gray-900 dark:text-gray-100 font-bold text-sm border-3 border-gray-900 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">Tailwind</span>
              </div>
            </div>
            <div>
              <div className="bg-yellow-400 dark:bg-yellow-500 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] border-6 border-gray-900 dark:border-emerald-600 p-8 dark:shadow-[12px_12px_0px_0px_rgba(5,150,105,1)] transform rotate-1">
                <div className="transform -rotate-1">
                  ...
                  <a href="mailto:hello@developer.com" className="inline-block px-6 py-3 bg-white dark:bg-neutral-900 text-gray-900 dark:text-white font-bold text-lg border-3 border-gray-900 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:translate-x-1 hover:translate-y-1 transition-transform">Email me</a>
                </div>
              </div>
            </div>
          </section>
